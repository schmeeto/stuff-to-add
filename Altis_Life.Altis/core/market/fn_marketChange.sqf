...
switch(true) do
{
	...
	{
		[[0,"News: The FBI have arrested an international smuggling ring!"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
	...
	{
		[[0,"News: Sunken Oil tanker!"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
	...
	{
		[[0,"News: Industries need precious materials!"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
		
		["goldbar", [15,30] call life_fnc_randomRound, true] call life_fnc_marketBuy; 
		diag_log "+Market+ Event copperr";
	};
	...
	{
		[[0,"News: New synthetic drug introduced to drug market!"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
